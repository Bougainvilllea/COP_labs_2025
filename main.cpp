...
int main () {
    ...
    if(pI1 == pI2){
        cout<<"IUnknown один и тот же"<<endl;
    }
    else{
        cout<<"IUnknown НЕ один и тот же"<<endl;
    }
    pI1->Release();
    pI2->Release();

    cout << "* Получить интерфейс снова, если смогли получить его раньше\n" << endl;
    ...
    cout << "\n* Получить интерфейс, который у Вас уже есть\n" << endl;
    IX* pIX2 = NULL;
